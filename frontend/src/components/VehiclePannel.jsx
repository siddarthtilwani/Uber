...
const  VehiclePannel=(props)=>{
    return(
        <div>
        <h5 onClick={()=>props.setvehiclePannelOpen(false)} className="absolute text-center w-[93%] p-1 top-0">  <i className="text-3xl text-gray-200 ri-arrow-down-wide-line"></i></h5>
